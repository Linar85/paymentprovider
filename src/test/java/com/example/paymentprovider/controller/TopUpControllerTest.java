...
class TopUpControllerTest {
    ...
    void createTopUpTransaction() {
        ...
        webTestClient.post().uri("/api/v1/payments/topup")
    ...
    void getTransactionsList() {
        ...
        webTestClient.get().uri("/api/v1/payments/topup/list")
                .exchange()
                .expectStatus().isOk()
    ...
    void getTransactionDetails() {
        ...
        webTestClient.get().uri("/api/v1/payments/topup/{id}/details", "test_id")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
